...
function App() {
  return (
    <div className="app">
      <header>
        <h1>IoT Ledger</h1>
        <p className="subtitle">Real-time IoT tracking for logistics</p>
      ...
      <main>
        <section className="info-card">
          ...
          <div className="contract-info">
            ...
            <code className="address">0x3D17192112E7B298cE5F7F27cb41963E96B89411</code>
            <a 
              href="https://megaexplorer.xyz/address/0x3D17192112E7B298cE5F7F27cb41963E96B89411"
              target="_blank"
        ...
        <section className="info-card">
          ...
          <a 
            href="https://github.com/RevjoyMe/iot-ledger"
            target="_blank"
            rel="noopener noreferrer"
